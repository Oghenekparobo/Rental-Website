    ...
    <div>
      ...
      <div className="relative">
        <div className="absolute inset-0">
          <img className="h-full w-full object-cover" src="/img/bg.jpg" />
        </div>
        <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8  bg-gray-800/80">
          <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
            Coded Rentals
            <span className="block text-gray-300">
              catch cruise on the Island
            </span>
          </h1>
          <p className="mt-6 max-w-2xl mx-auto text-center text-xl">
            The average price of houses for sale is ₦87,362,428 The most
            expensive house costs ₦1,000,000,000. while the cheapest costs
            ₦500,000. Well don't kill yourself the island is both overrated and
            underrated, just book with me, i give you balance in my apartment.
          </p>
